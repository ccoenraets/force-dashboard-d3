// credits: http://codepen.io/jaketrent/pen/eloGk

function gauge(selector, value) {
...
//    percent = .65;
    ...
    Needle = (function () {
        ...
        Needle.prototype.animateOn = function (el, perc) {
            var self;
            self = this;
            return el.transition().delay(200).ease('elastic').duration(500).selectAll('.needle').tween('progress', function () {
